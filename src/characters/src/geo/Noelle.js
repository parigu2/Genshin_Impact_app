...
import characterImg from '../../img/노엘.png'
import characterIcon from '../../img/icon/noelleIcon.png'

import { saltation } from '../../../element/src/elementReaction'

import { ensureObject } from '../../../util'

export class Noelle extends Geo {
  constructor(spec) {
    super(spec)
  ...
  getCharacterSpec() {
    return {
      ...
      // SKILL_RATE_E: this.SKILL_RATE_E, // Calculate based on DEF
